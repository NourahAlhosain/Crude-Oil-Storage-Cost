                    ...
                    callbacks: {
                        label: function (tooltipItem, data) {
                            ...
                            if (fieldChosen == 'SpreadOptValue') {
                                ...
                                label += " - (SoV): " + Math.round(tooltipItem.yLabel * 100) / 100 + ' $/Bbl';
                                return label;
                            }
            ...
            promise = view.hitTest(event).then(function (hit) {
                ...
                if (results.length) {
                    ...
                    if (fieldChosen == 'SpreadOptValue') {
                        tooltip.show(
                            screenPoint,
                            "Port Name: " + graphic.attributes["Location"] + "<br/> SoV = " + Math.round(+graphic.getAttribute(fieldChosen) * 100) / 100 + " $/Bbl"
